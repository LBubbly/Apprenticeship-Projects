...
class ToPostgres:
    ...
    def to_postres(self, dict_offset, dict_weather, dict_all):
        try: 
            # Logging starting execution of connection() 
            log.info(f'Started Execution of {self.connection.__name__}')
            ...
            all_data_table = property.access_config('all_data_table_name')

            table_name = [offset_table, weather_table, all_data_table]
            dict_list = [dict_offset, dict_weather, dict_all]
