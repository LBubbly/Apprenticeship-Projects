...
class WeatherProducer:
    ...
    def multithreaded_producing(self):
        ...
        ##### LOG TIMESTAMP TO VALIDATE & PROVE THAT MULTITHREADING WORKING (IN PARALLEL) #####
        threads = []
...
'''
# ENABLE USER TO LIST PARTITIONS, THEN SPLIT BY (', ') 
        # number_of_partitions = int(input('List Partitions...\nEg. 0, 4\nEnter Partitions: '))
